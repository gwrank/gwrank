class GuildsController < ApplicationController
  ...
  def index
    @pagy, @guilds = pagy(Guild.includes(:players).active.order(members_count: :desc, gold_trims_count: :desc, silver_trims_count: :desc, bronze_trims_count: :desc, name: :asc))
    authorize @guilds
  end
