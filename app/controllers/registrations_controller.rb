class RegistrationsController < ApplicationController
  ...
  def create
    ...
    if current_player.igname.present?
      message << "\nYour known in-game name is **#{current_player.igname}**. If you want to update it, please use */player register* **Your In Game Name*"
    else
      message << "\nYour in-game name is unknown. To be guested easily, please use */player register* **Your In Game Name**"
    end
