class RegistrationsController < ApplicationController
  ...
  def create
    ...
    if Registration.current_registrations.count.eql?(16)
      captain_a = Registration.current_registrations.sample.player
      captain_b = Registration.current_registrations.where.not(id: captain_a.current_registration.id).sample.player
      Scrim.create!(
        captain_a: captain_a,
        captain_b: captain_b,
      )
